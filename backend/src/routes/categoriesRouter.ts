...
categoriesRouter.post("/", isAuthenticated, isAdmin,hasCsrfToken, createCategory)
categoriesRouter.delete("/:categoryId", isAuthenticated, isAdmin, hasCsrfToken, deleteCategory);
